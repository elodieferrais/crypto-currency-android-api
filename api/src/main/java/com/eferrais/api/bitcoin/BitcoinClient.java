package com.eferrais.api.bitcoin;
 ...
 */
public class BitcoinClient extends BaseCryptoClient implements CryptoClientInterface {

    public BitcoinClient(Context context) {
        super(context);
    }

    @Override
    public void getBalance(final String address, final CryptoCallback<Account> callback) {
        String url = "http://btc.blockr.io/api/v1/address/info/" + address;
